  ...
  return (
    <div className="pt-32 pb-20 md:pt-40 md:pb-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="text-center">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-apple-gray-dark mb-6">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
          <Button className="bg-apple-blue hover:bg-blue-600 transition-colors rounded-full px-8 py-6 h-auto text-base font-medium">
      ...
      <div className="mt-16 flex justify-center">
        <div className="relative w-full max-w-4xl h-[400px] md:h-[500px] rounded-3xl bg-gradient-to-br from-slate-50 to-gray-100 shadow-lg overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center animate-subtle-float">
            <div className="w-3/4 h-3/4 bg-gradient-to-br from-blue-100 to-slate-50 rounded-3xl shadow-inner flex items-center justify-center">
              <div className="text-center">
